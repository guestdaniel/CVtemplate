...
% Modified from template by...
	% Can't find the link --- if anyone finds it, let me know!
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%-------------------------------------------------------------
% Make Your Name bold in \printbibliography and \fullcite{...}
% Sourced from... 
...
% Instructions:
%	1) Note that the code below is specific to biblatex-apa! If you
%		prefer to use a different type of bibliography style, you
%		need to examine the above links and modify it appropriately.
%	2) Add your papers/presentations to bibliography.bib, or replace
%		bibliography.bib with your own bib resource above.
%	3) Compile this document. For Linux users, using latexmk is
%		best. It will likely require multiple latex/biber calls.
%		For Windows/Mac users, or those who feel uncomfortable
%		with command line, you may want to try a LaTeX IDE which
%		compiles documents automatically.
%	4) Once it has compiled successfully, look in the file "cv.bbl"
%	5) In the .bbl file, each author name should be associated
%		with a unique hash. Find your hash and replace the hash
%		below with yours.
%-------------------------------------------------------------
...
\forcsvlist{\listadd\boldnames}
  {{7539a073f1d9064a3c4976d6c9c5d6aa}} % <---- HASH GOES HERE

%-------------------------------------------------------------
% Length and environment definitions
%-------------------------------------------------------------

% Define some indentation amounts for the environments
% Changing \step (default 2em) and \twostep (default 4em) controls
% indentation depth!
\newlength{\step}
\setlength{\step}{2em}
\newlength{\twostep}
